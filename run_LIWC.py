...
from loadfeatures import SpanishLIWC
...
# Model fitting
epochs = 20
history = model.fit([x_train, liwc_train], y_train, epochs=epochs, batch_size=160, validation_split=0.25, verbose=0, callbacks=callbacks, class_weight=class_weights)


# Modelo de la última iteracion
y_prob = model.predict([np.array(x_test), liwc_test], batch_size=160, verbose=1)
